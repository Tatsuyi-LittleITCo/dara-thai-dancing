  ...
  return (
    <main>
      ...
      <section className="hero">
        ...
        <div className="hero-inner container section grid grid-2" style={{alignItems:'center', gap:'2rem'}}>
          <div>
            <h1 className="h1">{t(lang,'hero_title')}</h1>
            <p className="p" style={{margin:'1rem 0 1.25rem'}}>{t(lang,'hero_desc')}</p>
            <div style={{display:'flex',gap:12,flexWrap:'wrap'}}>
              #classes{t(lang,'cta_join')}</a>
              #facebook{t(lang,'cta_fb')}</a>
            </div>
          </div>
          <div className="card" style={{padding:0,borderRadius:'1.25rem',overflow:'hidden'}}>
            /hero.jpg
          </div>
        </div>
      </section>
      ...
      <section id="about" className="section">
        <div className="container grid grid-2" style={{gap:'2rem'}}>
          <div>
            <h2 style={{color:'var(--accent-2)'}}>{t(lang,'about_title')}</h2>
          ...
          <aside className="card">
            ...
            <div className="p" style={{fontSize:14}}>
              ...
              <div><strong>{t(lang,'facebook')}:</strong> https://www.facebook.com/darathaidancing@darathaidancing</a></div>
            </div>
          </aside>
        </div>
      </section>
      ...
      {/* Classes */}
      <section id="classes" className="section" style={{background:'#fff',borderTop:'1px solid #e5e7eb',borderBottom:'1px solid #e5e7eb'}}>
        <div className="container">
          <h2 style={{color:'var(--accent-2)'}}>{t(lang,'classes_title')}</h2>
          <div className="grid grid-3" style={{marginTop:'1rem'}}>
            {[{title:t(lang,'kids_title'),desc:t(lang,'kids_desc')},{title:t(lang,'adults_title'),desc:t(lang,'adults_desc')},{title:t(lang,'troupe_title'),desc:t(lang,'troupe_desc')}].map((c,i)=> (
          ...
          <p className="p" style={{marginTop:12,fontSize:14,color:'#6b7280'}}>{t(lang,'timetable_note')}</p>
        </div>
      </section>
      ...
      {/* Contact */}
      <section id="contact" className="section" style={{background:'var(--soft-red)',borderTop:'1px solid #e5e7eb'}}>
        <div className="container grid grid-2" style={{gap:'2rem'}}>
          <div>
            <h2 style={{color:'var(--accent-2)'}}>{t(lang,'contact_title')}</h2>
            ...
            <div style={{display:'flex',gap:12,marginTop:8,flexWrap:'wrap'}}>
              https://www.facebook.com/darathaidancing{t(lang,'msg_fb')}</a>
